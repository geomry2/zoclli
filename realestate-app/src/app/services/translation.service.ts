...
const EN: Translations = {
  ...
  'prop.newPropertyHint': 'Create a building and start adding units',
  'prop.newPropertyLabel': 'Portfolio setup',
  'prop.newPropertyTitle': 'Add a new property',
  'prop.newPropertyFormHint': 'Start with the building name. You can add units right after.',
  'prop.create': 'Create',
  'prop.saving': 'Saving…',
...
const RU: Translations = {
  ...
  'prop.newPropertyHint': 'Создайте здание и сразу добавьте юниты',
  'prop.newPropertyLabel': 'Структура портфеля',
  'prop.newPropertyTitle': 'Добавить новый объект',
  'prop.newPropertyFormHint': 'Начните с названия здания. Юниты можно добавить сразу после этого.',
  'prop.create': 'Создать',
