...
const EN: Translations = {
  ...
  'tasks.subtitle': 'Operational follow-through across leads, clients, properties, and deals.',
  'tasks.newTask': '+ Task',
...
const RU: Translations = {
  ...
  'tasks.subtitle': 'Операционные задачи по лидам, клиентам, объектам и сделкам.',
